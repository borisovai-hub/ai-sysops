...
const sections = [
  ...
  { label: 'Проекты', icon: Package, paths: ['/publish', '/publish/runs', '/releases', '/projects', '/content'] },
  { label: 'Инструменты', icon: Wrench, paths: ['/logs', '/tunnels', '/analytics', '/tasks', '/files', '/git'] },
